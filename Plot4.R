...
#Plot data
#First create canvas with 4 diffrent "plots"

par(mfrow=c(2,2))
#Plot 1

plot(dData$Date,dData$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

#Plot 2

plot(dData$Date, dData$Voltage, type="l", xlab="datetime", ylab = "Voltage")
...
plot(dData$Date, dData$Global_reactive_power, type="l", xlab="datetime", ylab = "Global_reactive_power")
